...
for numero,elemento in zip(animales, numeros):
    print(f"Recorriendo conjuntos animales: {numero}")
    print(f"Recorriendo conjuntos numeros: {elemento}\n")
...
#       Esto no se puede con conjuntos
# #Froma no óptima de recorrer una conjuntos con su índce
# for num in range(len(numeros)):
#     print(numeros[num])

#Forma corrcta de recorrer una conjuntos con su índice
...
#Se ejecuta siempre 1 vez lo que hay dentro del else aunque la conjuntos esté vacía
else:
